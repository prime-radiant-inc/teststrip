...
- Any event carrying ⌘/⌃/⌥ is rejected outright (`GridKeyInput.init(event:)` line 259: `disallowedModifiers` must be empty) — so e.g. ⌘1/⌘2 lens switches never get eaten by this monitor.
