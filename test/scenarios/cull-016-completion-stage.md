...
`applyCullCompletionReviewPicks` (47 — `AppModel.swift:6841-6848`), the
...
`AppModel.swift:5695-5709`), and `cullRemainingSinglesFromCullingCompletion`
(51 — `AppModel.swift:5766-5791`). Also verified: "Move Rejects…" physically
