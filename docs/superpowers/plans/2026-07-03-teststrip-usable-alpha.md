...
- Current slice focused verification: `swift test --filter 'AppModelTests/testRequestEvaluationDispatchesWorkerRecognitionCommand|AppModelTests/testRequestEvaluationRequiresCachedPreview|AppModelTests/testRequestVisibleAssetEvaluationsDispatchesForLoadedAssets|AppModelTests/testRequestVisibleAssetEvaluationsSkipsAssetsWithoutCachedPreviews|AppModelTests/testRequestCurrentScopeAssetEvaluationsDispatchesCachedAssetsBeyondLoadedPage|AppModelTests/testCanRequestCurrentScopeAssetEvaluationsRequiresCatalogAssetsAndWorker|AppModelTests/testCanRequestVisibleAssetEvaluationsRequiresLoadedAssetsAndWorker|AppModelTests/testRequestCompareAssetEvaluationsDispatchesOnlyCachedCompareAssets'` passed after adding current-scope recognition evaluation over cached assets beyond the loaded page.
