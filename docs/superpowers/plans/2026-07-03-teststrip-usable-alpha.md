...
- People is selectable from the sidebar and top chrome as a live mockup backed by real face-signal coverage. It now shows an unnamed face-review strip and catalog-backed face review cards for face detections/quality signals, plus an explicit named-people empty state; named identities, clustering, suggestions, and naming/merge/dismiss workflows remain disabled placeholders.
