...
- Current slice: add a real `Recently Added` Library row backed by the latest completed import output set, matching the Studio mockup's post-import browsing route without adding a parallel query path.
