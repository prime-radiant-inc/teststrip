...
- Snapshot commit: `758dd51 Count culling decisions across active scope`
...
- Last broad unit verification: `swift test` passed with 519 tests after the culling active-scope count slice.
