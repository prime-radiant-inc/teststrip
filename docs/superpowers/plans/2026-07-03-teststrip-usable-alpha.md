...
- Snapshot commit: `23095a6 Group inspector evaluation signals`
...
- Last broad unit verification: `swift test` passed with 516 tests after the grouped inspector evaluation signal slice.
