...
- Snapshot commit: `1cc6ab5 Show live People review strip status`
...
- Last broad unit verification: `swift test` passed with 785 tests, 1 skipped, and 0 failures after the People review strip status fix.
