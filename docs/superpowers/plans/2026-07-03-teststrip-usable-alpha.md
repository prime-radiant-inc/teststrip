...
- Current slice: add culling shortcut feedback so keyboard metadata decisions remain visible after auto-advance, naming the changed frame and decision in the culling header.
