...
- Current slice: added typed keyword preview chips to the batch metadata popover so freeform bulk keyword entry is reviewed before applying to selected, visible, or current-scope batches.
