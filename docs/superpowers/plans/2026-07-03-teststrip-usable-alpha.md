...
- `9711768`: added explicit visual-similarity evaluation signals, grouped stacks from persisted visual vectors when present, wired compare/latest-import culling to those stacks, and kept provider generation plus threshold calibration honest as remaining work.
