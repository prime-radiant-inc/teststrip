...
- The current RAW story has an explicit ImageIO capability matrix and provider boundary plus local real DNG/RAF fixture coverage, but still lacks CRW/CR2/X3F fixture files and a non-ImageIO provider for unsupported or weakly supported families such as Sigma/Foveon X3F. Lytro support remains out of scope.
