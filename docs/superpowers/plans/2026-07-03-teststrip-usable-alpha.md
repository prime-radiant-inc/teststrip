...
- Current slice: added provider-signal Smart Collection suggestions so object-label, OCR, and people evaluation summaries can propose concrete saved-set rules while skipping already-active filters.
