...
- Current slice focused verification: the import-completion optional-review test failed while flagged, keyword, and face review rows rendered disabled empty states with no candidates, then passed after those optional follow-ups were omitted unless real review candidates exist. Earlier focused verification passed for local import stability, source-availability sidebar tone, inspector source-status copy, culling-stack visual-similarity vectors, multi-label recognition, source-root unavailable counts, culling-stack placeholder cleanup, People dead-UI cleanup, OCR caption suggestions, work-session query scopes, plain selection batch collapse, import completion skipped-file review, import-issue plumbing, latest-import flagged review, People face-review, Search/parser quoted/import parsing, and recognition retry/gates.
