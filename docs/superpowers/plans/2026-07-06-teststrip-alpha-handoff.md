...
2. If UI automation must stay non-focus-stealing: continue catalog/XMP live-review gaps at the presentation/model level, especially conflict review/resolution affordances that can be tested headlessly.
