...
final class LiveMockupPlaceholderTests: XCTestCase {
    ...
    func testKeywordingLedgerTracksCurrentScopeBatchMetadataGaps() throws {
        ...
        XCTAssertTrue(placeholder.currentFallback.localizedCaseInsensitiveContains("matching current-scope assets"))
        ...
        XCTAssertTrue(surface.currentImplementation.localizedCaseInsensitiveContains("matching current-scope assets"))
