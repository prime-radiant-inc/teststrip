...
final class LiveMockupPlaceholderTests: XCTestCase {
    ...
    func testPeopleFaceActionsLedgerOnlyMarksFutureAutomatedActionsAsDisabled() throws {
        ...
        XCTAssertTrue(placeholder.currentFallback.localizedCaseInsensitiveContains("automatic grouping suggestion cards"))
        XCTAssertTrue(placeholder.currentFallback.localizedCaseInsensitiveContains("nothing is written until the user confirms"))
        XCTAssertTrue(placeholder.currentFallback.localizedCaseInsensitiveContains("Split person"))
        XCTAssertTrue(placeholder.currentFallback.localizedCaseInsensitiveContains("face-box-level naming"))
    ...
    func testSearchRefineLedgerTracksGeneratedRefinementsAndSuggestedActions() throws {
        ...
        XCTAssertTrue(placeholder.currentFallback.localizedCaseInsensitiveContains("plain search fallback"))
        XCTAssertTrue(placeholder.currentFallback.localizedCaseInsensitiveContains("matching work history"))
