...
public struct WorkerCommandExecutor {
    ...
    public func execute(_ command: WorkerCommand, progress: LibraryImportProgressHandler? = nil) throws -> WorkerCommandResult {
        switch command {
        case .importFolder(let root, let duplicateHandling, let selectedFiles, _):
        ...
        case .importCard(let source, let destinationRoot, let destinationPolicy, let secondCopyDestination, let duplicateHandling, let selectedFiles, _):
