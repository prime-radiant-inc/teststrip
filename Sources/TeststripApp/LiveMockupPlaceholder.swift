...
public enum LiveMockupPlaceholders {
    ...
    public static let timelineLibrary = LiveMockupPlaceholder(
        ...
        currentFallback: "Catalog-backed capture-day counts, day drill-down, year-density ribbon, focused month/day scrubber, and month/year drill-down controls exist; scroll-position syncing remains pending."
    )
    ...
    public static let peopleSidebar = LiveMockupPlaceholder(
        ...
        currentFallback: "Selectable live mockup with an unnamed face review strip, face-review strip affordances backed by real face signals, and a named-people empty state; naming remains disabled and there are no named identities until clustering ships."
    )
    ...
    public static let searchRefine = LiveMockupPlaceholder(
        ...
        currentFallback: "Search view shows a deterministic Teststrip Reads rail from active filter chips, known target rows are actionable, and existing save/freeze/review workflows appear as suggested actions; agent-generated refinements are not built."
    )
    ...
    public static let keywordingBatch = LiveMockupPlaceholder(
        ...
        currentFallback: "Single-selected metadata controls plus latest-import/current-scope keyword suggestions and a visible/current-scope metadata popover write through catalog and XMP with all-catalog confirmation; multi-select batch review is not built."
    )
...
public enum LiveMockupDesignSurfaces {
    public static let all: [LiveMockupDesignSurface] = [
        ...
        LiveMockupDesignSurface(
            ...
            currentImplementation: "Timeline route uses catalog-backed capture-day counts, a year-density ribbon, focused month/day scrubber, day drill-down, and month/year drill-down into existing date predicates; scroll-position syncing remains pending."
        ),
        LiveMockupDesignSurface(
            designID: "2a",
            title: "Rapid cull",
        ...
        LiveMockupDesignSurface(
            ...
            currentImplementation: "People route is selectable and shows an unnamed face review strip, face-review strip affordances, catalog-backed review entrypoints, and a named-people empty state; naming remains disabled and no named identities, suggestions, or naming workflows are built."
        ),
        LiveMockupDesignSurface(
            designID: "5b",
            title: "Places",
        ...
        LiveMockupDesignSurface(
            ...
            currentImplementation: "Search route preserves catalog query/filter state, parsed chips, saved-set counts, results grid, and suggested actions for existing save/freeze/review workflows; agent-generated refinements and broader natural-language planning are not built."
        ),
        LiveMockupDesignSurface(
            designID: "5d",
        ...
        LiveMockupDesignSurface(
            ...
            currentImplementation: "Selected asset metadata controls edit keywords, caption, creator, and copyright with XMP writeback, plus single-asset, latest-import, current-scope keyword suggestions, and a visible/current-scope metadata popover from object evaluation labels with all-catalog confirmation; multi-select batch review is not built."
        ),
        LiveMockupDesignSurface(
            designID: "5f",
            title: "Export",
